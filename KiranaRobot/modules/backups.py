...
import KiranaRobot.modules.sql.notes_sql as sql
from KiranaRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from KiranaRobot.__main__ import DATA_IMPORT
from KiranaRobot.modules.helper_funcs.chat_status import user_admin
from KiranaRobot.modules.helper_funcs.alternate import typing_action

# from KiranaRobot.modules.rules import get_rules
import KiranaRobot.modules.sql.rules_sql as rulessql

# from KiranaRobot.modules.sql import warns_sql as warnssql
import KiranaRobot.modules.sql.blacklist_sql as blacklistsql
from KiranaRobot.modules.sql import disable_sql as disabledsql

# from KiranaRobot.modules.sql import cust_filters_sql as filtersql
# import KiranaRobot.modules.sql.welcome_sql as welcsql
import KiranaRobot.modules.sql.locks_sql as locksql
from KiranaRobot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("KiranaRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("KiranaRobot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `KiranaRobot-Backup` was specially made for notes.".format(
            chat.title,
            chat_id,
            tgl,
        ),
    ...
    os.remove("KiranaRobot{}.backup".format(chat_id))  # Cleaning file
