...
import KiranaRobot.modules.sql.connection_sql as sql
from KiranaRobot import dispatcher, DRAGONS, DEV_USERS
from KiranaRobot.modules.helper_funcs import chat_status
