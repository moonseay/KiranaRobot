...
from KiranaRobot.__main__ import STATS, TOKEN, USER_INFO
from KiranaRobot.modules.sql import SESSION
import KiranaRobot.modules.sql.userinfo_sql as sql
from KiranaRobot.modules.disable import DisableAbleCommandHandler
from KiranaRobot.modules.sql.global_bans_sql import is_user_gbanned
from KiranaRobot.modules.sql.afk_sql import is_afk, set_afk
from KiranaRobot.modules.sql.users_sql import get_user_num_chats
from KiranaRobot.modules.helper_funcs.chat_status import sudo_plus
from KiranaRobot.modules.helper_funcs.extraction import extract_user
from KiranaRobot import telethn
...
def stats(update: Update, context: CallbackContext):
    stats = "<b>╔═━「 Current kirana Statistics 」</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
...
*What is that health thingy?*
 Come and see [HP System explained](https://t.me/kiranaproject)
"""
