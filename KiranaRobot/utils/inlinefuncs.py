...
from KiranaRobot import pbot as app 
from KiranaRobot import arq
from KiranaRobot.services.keyboard import Ikb
from KiranaRobot.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from KiranaRobot.services.tasks import _get_tasks_text, all_tasks, rm_task
from KiranaRobot.services.types import InlineQueryResultCachedDocument
from KiranaRobot.modules.info import get_chat_info, get_user_info
from KiranaRobot.modules.music import download_youtube_audio
from KiranaRobot.utils.functions import test_speedtest
from KiranaRobot.utils.pastebin import paste
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://graph.org/file/f98b6d9fb5e1d78ea4a1a.jpg",
...
async def alive_function(answers):
    ...
    msg = f"""
**[Kirana Robot️](https://t.me/kiranasupport):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
