...
import sys
import traceback
import KiranaRobot.modules.sql.users_sql as sql
from sys import argv
from typing import Optional
from telegram import __version__ as peler
from platform import python_version as memek
from KiranaRobot import (
    ALLOW_EXCL,
    CERT_PATH,
    DONATION_LINK,
    BOT_USERNAME as bu,
...
from KiranaRobot.modules import ALL_MODULES
from KiranaRobot.modules.helper_funcs.chat_status import is_user_admin
from KiranaRobot.modules.helper_funcs.misc import paginate_modules
...
buttons = [
    [
        InlineKeyboardButton(text=f"ᴀʙᴏᴜᴛ {dispatcher.bot.first_name}", callback_data="kirana_"),
    ],
    [
    ...
    [
        InlineKeyboardButton(
            text="➗ ᴛᴀᴍʙᴀʜᴋᴀɴ ꜱᴀʏᴀ ᴋᴇ ɢʀᴏᴜᴘ ᴀɴᴅᴀ ➗", url=f"t.me/{bu}?startgroup=new"),
    ],
]
...
DONATE_STRING = """ʜᴇʏᴀ, ɢʟᴀᴅ ᴛᴏ ʜᴇᴀʀ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴅᴏɴᴀᴛᴇ!!
 ʏᴏᴜ ᴄᴀɴ ꜱᴜᴘᴘᴏʀᴛ ᴛʜᴇ ᴘʀᴏᴊᴇᴄᴛ ʙʏ ᴄᴏɴᴛᴀᴄᴛɪɴɢ @moonseay \
 ꜱᴜᴘᴘᴏʀᴛɪɴɢ ɪꜱɴᴛ ᴀʟᴡᴀʏꜱ ꜰɪɴᴀɴᴄɪᴀʟ! \
 ᴛʜᴏꜱᴇ ᴡʜᴏ ᴄᴀɴɴᴏᴛ ᴘʀᴏᴠɪᴅᴇ ᴍᴏɴᴇᴛᴀʀʏ ꜱᴜᴘᴘᴏʀᴛ ᴀʀᴇ ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ʜᴇʟᴘ ᴜꜱ ᴅᴇᴠᴇʟᴏᴘ ᴛʜᴇ ʙᴏᴛ ᴀᴛ ."""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("KiranaRobot.modules." + module_name)
...
def kirana_about_callback(update, context):
    query = update.callback_query
    if query.data == "kirana_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="ᴀᴅᴍɪɴ", callback_data="kirana_admin"),
                    InlineKeyboardButton(text="ɴᴏᴛᴇꜱ", callback_data="kirana_notes"),
                 ],
                 [
                    InlineKeyboardButton(text="ꜱᴜᴘᴘᴏʀᴛ", callback_data="kirana_support"),
        ...
        query.message.edit_text(
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="Go Back", callback_data="kirana_")]]
            ),
        )

    elif query.data == "kirana_notes":
        query.message.edit_text(
    ...
    elif query.data == "kirana_support":
        query.message.edit_text(
            text="*๏ Kirana support chats*"
            f"\nJoin My Support Group/Channel for see or report a problem on {dispatcher.bot.first_name}.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="ꜱᴜᴘᴘᴏʀᴛ", url="t.me/kiranasupport"),
                    InlineKeyboardButton(text="ᴜᴘᴅᴀᴛᴇs", url="https://t.me/kiranaproject"),
                 ],
                 [
                    InlineKeyboardButton(text="ɢᴏ ʙᴀᴄᴋ", callback_data="kirana_"),
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(
        kirana_about_callback, pattern=r"kirana_", run_async=True
    )
