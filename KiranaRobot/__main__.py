...
buttons = [
    [
        InlineKeyboardButton(
            text=f"ᴀʙᴏᴜᴛ {dispatcher.bot.first_name}", callback_data="kirana_"
        ),
    ],
    [
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="ᴀᴅᴍɪɴ", callback_data="kirana_admin"
                        ),
                        InlineKeyboardButton(
                            text="ɴᴏᴛᴇꜱ", callback_data="kirana_notes"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                            text="ꜱᴜᴘᴘᴏʀᴛ", callback_data="kirana_support"
                        ),
                        InlineKeyboardButton(
                            text="ᴄʀᴇᴅɪᴛs", callback_data="kirana_credit"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                            text="sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ",
                            url="https://telegra.ph/file/2f25734a9ff205d0ed043.jpg",
                        ),
                    ],
                    [
                        InlineKeyboardButton(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="ᴜᴘᴅᴀᴛᴇs", url="https://t.me/kiranaproject"
                        ),
                    ],
                    [
